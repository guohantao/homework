...
public class _14211469_郭瀚涛_2_StudentTest {
	...
	public static void main(String[] args) throws IOException
	{
		...
		_14211469_郭瀚涛_2_Student s1 = new _14211469_郭瀚涛_2_Student(number,name);
...
class Testexception
{
	...
	public void test() throws _14211469_郭瀚涛_2_SoreException, _14211469_郭瀚涛_2_StudentNumberException
	{
		...
		if(num.length() <= 2 || (num.charAt(0) !=  '2') || (num.charAt(1) != '0')) //注意是字符不是数字
		{
